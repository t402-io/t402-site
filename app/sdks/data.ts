...
http.Handle("/", middleware(handler))`,
  ...
  },
  {
    ...
    icon: "java",
    installCommand: "io.t402:t402:1.7.0",
...
export const typescriptPackages: Package[] = [
  ...
  },
  {
    ...
    features: ["Multi-chain support", "EIP-3009 gasless", "USDT/USDC payments", "Viem integration"],
  },
  {
    name: "@t402/svm",
    npmPackage: "@t402/svm",
  ...
  },
  {
    ...
    features: ["Route protection", "Paywall UI", "Settlement handling", "Migration guide"],
  },
  {
    name: "@t402/hono",
  ...
  },
  {
    ...
    description: "Gasless USDT0 payments via EIP-3009",
    features: ["Zero gas fees", "Permit signatures", "Relayer support", "WDK integration"],
  },
  {
    name: "@t402/wdk-bridge",
    npmPackage: "@t402/wdk-bridge",
    description: "Cross-chain USDT0 bridging via LayerZero",
