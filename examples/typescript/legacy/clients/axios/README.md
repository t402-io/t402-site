# t402-axios Example Client

This is an example client that demonstrates how to use the `t402-axios` package to make HTTP requests to endpoints protected by the t402 payment protocol.
