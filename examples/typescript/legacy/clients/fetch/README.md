...
This is an example client that demonstrates how to use the `t402-fetch` package to make HTTP requests to endpoints protected by the t402 payment protocol.
...
2. Wrap the native fetch function with t402 payment handling
