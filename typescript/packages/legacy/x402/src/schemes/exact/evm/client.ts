...
export async function createPayment<transport extends Transport, chain extends Chain>(
  ...
  const unsignedPaymentHeader = preparePaymentHeader(from, t402Version, paymentRequirements);
...
export async function createPaymentHeader(
  ...
  const payment = await createPayment(client, t402Version, paymentRequirements);
