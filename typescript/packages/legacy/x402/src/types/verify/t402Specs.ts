...
export const t402Versions = [1] as const;
...
export const PaymentPayloadSchema = z.object({
  t402Version: z.number().refine(val => t402Versions.includes(val as 1)),
  scheme: z.enum(schemes),
  network: NetworkSchema,
...
// t402 Resource Server Response
export const t402ResponseSchema = z.object({
  t402Version: z.number().refine(val => t402Versions.includes(val as 1)),
...
export type t402Response = z.infer<typeof t402ResponseSchema>;

// t402RequestStructure
...
// t402ListDiscoveryResourcesResponse
...
// t402SupportedPaymentKindsResponse
